...
import { createProject } from './../data/actions/projectAction'
...
class CreateProject extends Component {
	...
	handleUploadSuccess = filename => {
		...
		firebase.storage().ref('Portfolio').child(filename).getDownloadURL()
				...
				<div className="container">
					<form onSubmit={this.handleSubmit} className="white">
						...
						<div className="input-field select-wrapper">
							<select id="catagory" name="catagory" onChange={this.handleChange} multiple={false} value={this.state.catagory}>
								<option value="tab" disabled>Choose a catagory</option>
						...
						<div className="input-field">
							...
							<input type="text" id="project" onChange={this.handleChange} value={this.state.project} />
						</div>
						<div className="input-field">
						...
						<div className="input-field">
							...
							<input type="text" id="gitHub" onChange={this.handleChange} value={this.state.gitHub} />
						</div>
